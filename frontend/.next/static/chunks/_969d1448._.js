...
function UploadForm() {
    ...
    const fileKind = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "UploadForm.useMemo[fileKind]": ()=>humanFileType(file)
    }["UploadForm.useMemo[fileKind]"], [
        file
    ]);
    ...
    async function onSubmit(e) {
        ...
        try {
            ...
            router.push("/results?".concat(params.toString()));
        } finally{
            setSubmitting(false);
        }
    }
...
_s(UploadForm, "HLmr4wvaXJsMbyipDUKrMDY9W5A=", false, function() {
    return [
...
//# sourceMappingURL=_969d1448._.js.map